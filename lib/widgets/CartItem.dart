...
class _CartItemState extends State<CartItem> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onLongPress: () async {
        await fireStoreDelete.DeleteProductFromCart(
              ...
              child: SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    IconButton(
                      onPressed: () {
                        if (widget.productModel.sllercount != null) {
                          widget.productModel.sllercount =
                              widget.productModel.sllercount! - 1;
                          setState(() {});
                        }
                      },
                      icon: const Icon(
                    ...
                    Text(
                      widget.productModel.sllercount.toString(),
                      style: const TextStyle(
